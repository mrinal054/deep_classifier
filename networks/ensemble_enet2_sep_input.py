...
if __name__ == "__main__":
    ...
    out_channels = [1024]
    dropout = 0.3
    model = EnsembleEnet2SepIn(num_classes=num_classes, out_channels=out_channels, dropout=dropout)
