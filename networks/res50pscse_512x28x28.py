...
class ResNet50_Upto_512x28x28(nn.Sequential):
    def __init__(self, pretrain:bool=True):
        ...
        super(ResNet50_Upto_512x28x28, self).__init__(
            resnet50.conv1,
            resnet50.bn1,
            resnet50.relu,
            resnet50.maxpool,
...
class ResNet50Pscse_512x28x28(nn.Module):
    def __init__(self,
                 num_classes,
        ...
        super(ResNet50Pscse_512x28x28, self).__init__()

        self.clipped_model = ResNet50_Upto_512x28x28(pretrain=pretrain)

        self.pscse_cab_1 = PscSEWithCAB(in_ch=512,
                                     out_ch=512,
    ...
    def forward(self, x):
        ...
        x = self.pscse_cab_1(x) # 512x14x14
        x = self.pscse_cab_2(x) # 1024x7x7
...
if __name__ == "__main__":
    ...
    model = ResNet50Pscse_512x28x28(num_classes, out_channels, pretrain, dropout, activation, reduction)
